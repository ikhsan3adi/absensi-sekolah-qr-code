...
<?= $this->endSection() ?>
                  ...
                  <div class="card">
                     ...
                     <div class="row mt-3">
                        <div class="col-12 text-center">
                           <input type="text" id="rfidInput" class="form-control mx-auto" style="width: 80%;"
                              placeholder="Klik disini & Scan Kartu RFID" autofocus autocomplete="off">
                           <small class="text-muted">Pastikan kursor aktif di kolom ini saat scan kartu.</small>
                        </div>
                     </div>
   ...
   <script type="text/javascript">
      ...
      $(document).ready(function () {
         ...
         // Ensure focus remains on rfidInput if clicked elsewhere
