                ...
                success: function (response) {
                    ...
                    if (objSub.result == 1) {
                        ...
                        if (objSub.status == 'duplicate') {
                            $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-warning">&nbsp;' + objSub.index + '.&nbsp; - ' + objSub.kelas.tingkat + ' ' + objSub.kelas.jurusan + ' ' + objSub.kelas.index_kelas + ' (Sudah Ada)</li>');
                        } else {
                            $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-success">&nbsp;' + objSub.index + '.&nbsp; - ' + objSub.kelas.tingkat + ' ' + objSub.kelas.jurusan + ' ' + objSub.kelas.index_kelas + '</li>');
                        }
                    } else {
