            ...
            <?php foreach ($data as $value) : ?>
               ...
               <tr>
                  ...
                  <td>
                     <?php if (!$lewat) : ?>
                        <div class="dropstart">
                           <button type="button" class="btn btn-info p-2 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" id="<?= $value['nuptk']; ?>">
                              <i class="material-icons">edit</i>
                              Edit
                           </button>
                           <ul class="dropdown-menu" aria-labelledby="<?= $value['nuptk']; ?>">
                              <li>
                              ...
                              <?php foreach ($listKehadiran as $value2) : ?>
                                 ...
                                 <?php else : ?>
                                    <li class="p-1 mr-2">
                                       ...
                                       <?php else : ?>
                                          <button onclick="ubahKehadiran(<?= $value2['id_kehadiran']; ?>, <?= $value['id_guru']; ?>)" class="w-100 dropdown-item text-white btn btn-<?= $color; ?>">
                                             <?= $value2['kehadiran']; ?>
                                          </button>
                                       <?php endif; ?>
                                    </li>
