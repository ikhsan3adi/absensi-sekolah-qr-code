...
<link rel="stylesheet" href="<?= base_url('assets/css/material-dashboard.css?v=' . $assetVersion); ?>" />
<link rel="stylesheet" href="<?= base_url('assets/css/style.css?v=' . $assetVersion); ?>" />
